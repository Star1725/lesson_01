...
public class guessTheNumber {
    ...
    public static String compareMethod(int genNum, int userNum){
        ...
        if(countTry == 0)return "Попытки кончились. GAME OVER!!! Я загадал - " + genNum;
        ...
        else if (userNum < 0 || userNum > 9) return "Я же сказал от 0 до 9!  " + (countTry == 0 ? "Попытки кончились." : "Минус одна попытка.");
